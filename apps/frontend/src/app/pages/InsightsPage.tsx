...
export function InsightsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <section aria-label="Insights identity" className="mb-6 grid gap-3 partha-surface p-5 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="mb-7 grid gap-5 lg:grid-cols-2">
        ...
        <section className="partha-surface p-5">
      ...
      <section className="mb-7 partha-surface p-5">
      ...
      <section className="mb-8 flex items-start gap-2 partha-surface p-4">
...
function MetricCard({ metric }: { metric: InsightMetric }) {
  ...
  return (
    <article className="partha-surface p-4">
