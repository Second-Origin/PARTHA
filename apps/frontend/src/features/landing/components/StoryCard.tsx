...
function ServiceNode({ left, top, name, tech, icon }: NodeSpec) {
  return (
    <div className="absolute" style={{ left, top, width: 99, height: 99 }}>
      ...
      <p className="absolute left-0 right-0 top-[71.5px] text-center font-body text-[12px] font-normal not-italic leading-[normal] tracking-[-0.28px] text-black">
        {tech}
      </p>
    </div>
  );
...
function RequestPanel() {
  return (
    <div className="absolute" style={{ left: 386.5, top: 334.5, width: 304, height: 77 }}>
      ...
      <p className="absolute left-[82px] top-[10px] font-body text-[13px] font-normal not-italic leading-[normal] tracking-[-0.28px] text-black">
        POST/Login
      </p>
      <div
      ...
      />
      <p
        className="absolute text-center font-body text-[10px] font-normal not-italic leading-[17px] tracking-[-0.2px]"
      ...
      <p
        className="absolute font-body text-[12px] font-normal not-italic leading-[14.4px] tracking-[-0.24px] text-black"
...
function DependencyFurniture() {
  const label =
    'absolute font-body text-[12px] font-normal not-italic leading-[normal] tracking-[-0.24px] text-[var(--story-ink-soft)]';
  return (
    <>
      ...
      <div className="absolute inset-[8.02%_43.81%_7.82%_0] flex flex-col content-stretch items-start justify-center py-[40px] pl-[80px] pr-[40px]">
        ...
        <div className="relative flex w-full shrink-0 flex-col content-stretch items-start pt-[26px]">
          <div className="relative flex shrink-0 flex-col content-stretch items-start opacity-70">
            <p className="relative w-[280px] shrink-0 font-body text-[16px] font-normal not-italic leading-[19.2px] tracking-[-0.48px] text-[var(--story-ink-soft)] [word-break:break-word]">
              {variant.body}
            </p>
          </div>
        </div>
