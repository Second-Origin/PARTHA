...
import { faqAnswers, faqQuestions } from '@/features/landing/faq';
            ...
            >
              <div className="overflow-hidden">
                <p
                  ...
                  aria-hidden={!open}
                  className="px-[20px] pb-[18px] font-body text-[14px] font-normal not-italic leading-[19.6px] text-[var(--ln-faq-ink-soft)]"
                >
                  {faqAnswers[i]}
                </p>
              </div>
