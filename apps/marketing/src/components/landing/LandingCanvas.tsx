...
import { ThemeControl } from '@/components/landing/ThemeControl';
  ...
  return (
    <div className="landing-canvas bg-[var(--ln-page)] relative size-full" data-node-id="1:2" data-name="Landing Page">
      <div className="absolute h-[873px] left-0 overflow-clip top-[133px] w-[1728px]" data-node-id="143:163" data-name="Container - Hero">
        ...
        <div className="[word-break:break-word] absolute font-sans font-normal h-[27px] leading-[0] left-[467px] not-italic text-[#7a7a7a] text-[20px] text-justify top-[733px] uppercase w-[857px]" data-node-id="102:13">
            ...
            <div className="content-stretch flex h-[417px] items-center justify-center mb-[-24px] relative shrink-0 w-[272px]" data-node-id="539:4791" data-name="Container">
              <div className="h-[243px] max-w-[290px] relative shrink-0 w-[272px]" data-node-id="539:4792" data-name="Container">
                ...
                <div className="absolute bg-[var(--extended-colors\/on-custom-color-1,white)] border border-[#fa4d01] border-solid content-stretch flex h-[41px] items-center left-[73px] px-[10px] py-[8px] rounded-[7px] top-[-7px] w-[63px]" data-node-id="539:4794" data-name="Container">
                  <p className="[word-break:break-word] font-sans font-normal leading-[normal] not-italic relative shrink-0 text-[var(--ln-ink)] text-[10.4px] tracking-[-0.312px] whitespace-nowrap" data-node-id="539:4795">
                    Revision
                  </p>
                </div>
                <div className="absolute bg-[#fa4d01] content-stretch flex gap-[4px] h-[38px] items-center justify-center left-[162px] px-[12px] rounded-[7px] top-[108px] w-[119px]" data-node-id="539:4796" data-name="Container">
                  ...
                  <p className="[word-break:break-word] font-sans font-normal leading-[normal] not-italic relative shrink-0 text-[10.4px] text-[color:var(--extended-colors\/on-custom-color-1,white)] tracking-[-0.312px] whitespace-nowrap" data-node-id="539:4799">
                    Sealed Snapshot
                  </p>
                </div>
                <div className="absolute bg-[var(--extended-colors\/on-custom-color-1,white)] border border-[#fa4d01] border-solid content-stretch flex gap-[4px] h-[41px] items-center justify-center left-[10px] px-[8px] rounded-[6px] top-[202px] w-[88px]" data-node-id="539:4800" data-name="Container">
                  ...
                  <p className="[word-break:break-word] font-sans font-normal leading-[normal] not-italic relative shrink-0 text-[var(--ln-ink)] text-[10.4px] tracking-[-0.312px] whitespace-nowrap" data-node-id="539:4806">
                    Repository
                  </p>
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-sans font-normal leading-[21.125px] not-italic relative shrink-0 text-[16px] text-[var(--ln-ink)] w-[272px]" data-node-id="539:4807">{`Connect a repository, choose the revision you want to analyze, & let PARTHA create a sealed snapshot tied to that exact version.`}</p>
          </div>
          <div className="absolute bg-[var(--ln-grey)] content-stretch flex flex-col h-[604px] items-center left-[400px] overflow-clip p-[24px] rounded-[20px] top-0 w-[382px]" data-node-id="539:4808" data-name="Container">
            ...
            <div className="h-[364px] mb-[-10px] relative shrink-0 w-[272px]" data-node-id="539:4814" data-name="Container">
              <div className="absolute h-[213px] left-0 overflow-clip top-[75px] w-[140px]" data-node-id="539:4815" data-name="Icon">
                ...
                <div className="[word-break:break-word] absolute contents font-sans font-normal italic inset-[10.7%_22.5%_14.18%_22.5%] italic leading-[normal] text-[11.7px] text-[var(--ln-ink)] text-center whitespace-nowrap" data-node-id="539:4822" data-name="Group">
            ...
            <p className="[word-break:break-word] font-sans font-normal leading-[21.125px] not-italic relative shrink-0 text-[16px] text-[var(--ln-ink)] w-[272px]" data-node-id="539:4838">{`PARTHA maps the repository’s files, symbols, routes, dependencies, & relationships while generating evidence for the supported parts of the system.`}</p>
          </div>
          <div className="absolute bg-[var(--ln-sand)] content-stretch flex flex-col h-[604px] items-center left-[800px] overflow-clip p-[24px] rounded-[20px] top-0 w-[382px]" data-node-id="539:4839" data-name="Container">
            ...
            <div className="content-stretch flex h-[392px] items-center justify-center mb-[-16px] relative shrink-0 w-[272px]" data-node-id="539:4845" data-name="Container">
              <div className="h-[204.375px] overflow-clip relative shrink-0 w-[272px]" data-node-id="539:4846" data-name="Icon">
                ...
                <p className="[word-break:break-word] absolute font-sans font-normal inset-[8.41%_4.78%_85.23%_73.53%] leading-[13px] not-italic text-[10px] text-[var(--ln-ink)] tracking-[-0.9px] whitespace-nowrap" data-node-id="539:4865">
                  auth.service.ts
                </p>
                <p className="[word-break:break-word] absolute font-sans font-normal inset-[19.17%_9.19%_74.46%_73.53%] leading-[13px] not-italic text-[10px] text-[var(--ln-ink)] tracking-[-0.9px] whitespace-nowrap" data-node-id="539:4866">
                  Lines 42–78
                </p>
            ...
            <p className="[word-break:break-word] font-sans font-normal leading-[17.6px] not-italic relative shrink-0 text-[16px] text-[var(--ln-ink)] tracking-[-0.32px] w-[272px]" data-node-id="539:4882">
      ...
      <div className="absolute h-[1384px] left-[74px] top-[1006px] w-[1583px]" data-node-id="550:1349" data-name="product">
        <div className="absolute h-[1328px] left-[-16px] right-[-16px] top-0" data-node-id="550:1350" data-name="Container">
          ...
          <div className="absolute contents left-[62.15px] top-[298px]" data-node-id="562:3932">
            ...
            <p className="[word-break:break-word] absolute font-sans font-normal leading-[19.2px] left-[860px] not-italic text-[16px] text-[var(--ln-ink-70)] top-[607px] tracking-[-0.48px] w-[280px]" data-node-id="560:3759">
            ...
            <p className="[word-break:break-word] absolute font-sans font-medium inset-[41.94%_8.26%_57.08%_83.36%] leading-[13px] not-italic text-[20px] text-[var(--ln-ink)] tracking-[-0.9px]" data-node-id="560:3778">
              auth.service.ts
            </p>
            <div className="[word-break:break-word] absolute flex flex-col font-sans font-normal inset-[44.88%_16.08%_53.84%_81.13%] justify-center leading-[0] not-italic text-[16px] text-[var(--ln-ink)] tracking-[-0.9px]" data-node-id="560:3793">
            ...
            <div className="absolute contents left-[1310.25px] top-[596px]" data-node-id="560:3798">
              ...
              <p className="[word-break:break-word] absolute font-sans font-normal inset-[45.11%_7.95%_54.07%_89.14%] leading-[13px] not-italic text-[#7a7a7a] text-[10px] tracking-[-0.9px]" data-node-id="560:3796">
                Lines 42–78
              </p>
              <p className="[word-break:break-word] absolute font-sans font-normal inset-[47.67%_14.59%_51.51%_81.13%] leading-[13px] not-italic text-[#7a7a7a] text-[10px] text-center tracking-[-0.9px]" data-node-id="560:3800">
                Revision 9f3c7a2
              </p>
            ...
            <p className="[word-break:break-word] absolute font-sans font-medium inset-[29.89%_10.24%_69.13%_82.87%] leading-[13px] not-italic text-[20px] text-[var(--ln-ink)] tracking-[-0.9px]" data-node-id="561:3819">
              AuthService
            </p>
            ...
            <p className="[word-break:break-word] absolute font-sans font-normal h-[41px] leading-[19.2px] left-[90px] not-italic text-[16px] text-[var(--ln-ink-70)] top-[1135px] tracking-[-0.48px] w-[285px]" data-node-id="562:3832">
            ...
            <div className="absolute contents left-[518px] top-[954px]" data-node-id="562:3931">
              ...
              <div className="absolute contents left-[523px] top-[975px]" data-node-id="562:3918">
                ...
                <p className="[word-break:break-word] absolute font-sans font-medium inset-[74.17%_59.84%_24.85%_35.75%] leading-[13px] not-italic text-[16px] text-[var(--ln-ink)] tracking-[-0.9px]" data-node-id="562:3922">
                  Extracted
                </p>
                <p className="[word-break:break-word] absolute font-sans font-medium inset-[78.69%_61.27%_20.33%_35.75%] leading-[13px] not-italic text-[16px] text-[var(--ln-ink)] tracking-[-0.9px]" data-node-id="562:3923">
                  Partial
                </p>
                <p className="[word-break:break-word] absolute font-sans font-medium inset-[83.21%_58.66%_15.81%_35.75%] leading-[13px] not-italic text-[16px] text-[var(--ln-ink)] tracking-[-0.9px]" data-node-id="562:3924">
                  Not Assesed
                </p>
                <p className="[word-break:break-word] absolute font-sans font-normal inset-[74.25%_54.56%_24.92%_43.02%] leading-[13px] not-italic text-[#7a7a7a] text-[10px] tracking-[-0.9px]" data-node-id="562:3925">
                  213 items
                </p>
                <p className="[word-break:break-word] absolute font-sans font-normal inset-[78.77%_54.56%_20.41%_43.2%] leading-[13px] not-italic text-[#7a7a7a] text-[10px] tracking-[-0.9px]" data-node-id="562:3926">
                  30 items
                </p>
                <p className="[word-break:break-word] absolute font-sans font-normal inset-[83.28%_54.5%_15.89%_43.33%] leading-[13px] not-italic text-[#7a7a7a] text-[10px] tracking-[-0.9px]" data-node-id="562:3927">
                  73 items
                </p>
            ...
            <div className="absolute content-stretch flex flex-col inset-[8.02%_43.81%_7.82%_0] items-start justify-center pl-[50px] pr-[40px] py-[40px]" data-node-id="562:4001" data-name="Container">
              ...
              <div className="content-stretch flex flex-col items-start pt-[26px] relative shrink-0 w-full" data-node-id="562:4007" data-name="Paragraph:margin">
                <div className="content-stretch flex flex-col h-[57.609px] items-start opacity-70 relative shrink-0" data-node-id="562:4008" data-name="Paragraph">
                  <p className="[word-break:break-word] font-sans font-normal leading-[19.2px] not-italic relative shrink-0 text-[16px] text-[var(--ln-ink-70)] tracking-[-0.48px] w-[280px]" data-node-id="562:4009">
            ...
            <div className="absolute contents inset-[22.85%_2.66%_11.82%_47.54%]" data-node-id="562:4010" style={{ containerType: "size" }}>
              <div className="absolute contents inset-[22.85%_2.66%_11.82%_47.54%]" data-node-id="562:4089" style={{ containerType: "size" }}>
                ...
                <div className="absolute contents inset-[22.85%_2.66%_57.11%_84.02%]" data-node-id="562:4026">
                  ...
                  <p className="[word-break:break-word] absolute font-sans font-normal inset-[37.27%_7.72%_59.52%_88.95%] leading-[normal] not-italic text-[12px] text-[var(--ln-ink)] tracking-[-0.28px] whitespace-nowrap" data-node-id="562:4034">
                    Files
                  </p>
                ...
                <div className="absolute contents inset-[22.85%_20.91%_57.11%_65.78%]" data-node-id="562:4035">
                  ...
                  <p className="[word-break:break-word] absolute font-sans font-normal inset-[37.27%_22.64%_59.52%_67.38%] leading-[normal] not-italic text-[12px] text-[var(--ln-ink)] tracking-[-0.28px] whitespace-nowrap" data-node-id="562:4041">
                    Relationships
                  </p>
                </div>
                <div className="absolute contents inset-[22.85%_39.15%_57.11%_47.54%]" data-node-id="562:4042">
                  ...
                  <p className="[word-break:break-word] absolute font-sans font-normal inset-[37.27%_42.61%_59.52%_51%] leading-[normal] not-italic text-[12px] text-[var(--ln-ink)] tracking-[-0.28px] whitespace-nowrap" data-node-id="562:4051">
                    Symbols
                  </p>
                </div>
                ...
                <p className="[word-break:break-word] absolute font-sans font-normal inset-[83.17%_25.97%_13.63%_66.31%] leading-[normal] not-italic text-[12px] text-[var(--ln-ink)] tracking-[-0.28px] whitespace-nowrap" data-node-id="562:4091">
                  4 modules
                </p>
      ...
      <div className="absolute contents left-0 top-0" data-node-id="157:30" data-name="NAVBAR">
        ...
        <div className="absolute contents left-[78px] top-[40px]" data-node-id="199:1882">
          ...
          <div className="absolute contents left-[463px] top-[40px]" data-node-id="88:1536" data-name="Navbar 2">
            ...
            <button className="-translate-x-1/2 [word-break:break-word] absolute block capitalize cursor-pointer font-display font-medium font-medium h-[28.01px] leading-[0] left-[727.5px] text-[24px] text-[var(--ln-ink)] text-center top-[51.99px] w-[177px]" data-node-id="87:1524">
              <p className="leading-[normal]">How it works</p>
            </button>
            <button className="-translate-x-1/2 [word-break:break-word] absolute block capitalize cursor-pointer font-display font-medium font-medium h-[28.01px] leading-[0] left-[931px] text-[24px] text-[var(--ln-ink)] text-center top-[51.99px] w-[152px]" data-node-id="87:1526">
              <p className="leading-[normal]">Capabilities</p>
            </button>
            <button className="-translate-x-1/2 [word-break:break-word] absolute block capitalize cursor-pointer font-display font-medium font-medium h-[28px] leading-[0] left-[1073px] text-[24px] text-[var(--ln-ink)] text-center top-[52px] w-[54px]" data-node-id="87:1528">
