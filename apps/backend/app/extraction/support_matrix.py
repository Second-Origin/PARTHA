...
PUBLIC_CAPABILITIES: tuple[PublicCapability, ...] = (
    ...
    PublicCapability("change-impact", "Change-impact or blast-radius analysis", "Implemented, limited", "Owner-scoped traversal over one sealed snapshot's resolved import and dependency edges. It does not compare revisions or calculate churn or trends."),
