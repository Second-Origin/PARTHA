...
| Authentication explanation (#95) | `app/analysis/authentication.py` | exclusively the sealed snapshot query layer — routes, `routes_to`/`injects` edges, `classified_as` assertions, diagnostics. No legacy read. |
