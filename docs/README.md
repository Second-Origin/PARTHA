...
| [Repository Intelligence v1 RFC](architecture/REPOSITORY_INTELLIGENCE_V1_RFC.md) | Contributors on the intelligence track | **Proposed** architectural contract (RFC-0001, tracking [#86](https://github.com/Second-Origin/PARTHA/issues/86)) for the future snapshot/evidence schema: stable keys, provenance, truth classes, immutability, diagnostics, versioning, and the canonical graph hash. It describes an **approved-future contract, not current behaviour** — §17 states plainly what is unimplemented. Governs downstream issues #87–#95. |
